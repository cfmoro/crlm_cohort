...
p <- ggsurvplot(fit.dat, data = fun.dat, 
    title = paste(cohort_type, "patients"),
    xlab = "Days", 
...
fit.coxph <- coxph(survObjectOS ~ neoadjuvant + sex + sync_meta + age_ + num_tumors_ + max_tum_diameter + sum_tum_diameter + marginal0 + tum_percent_annot_ + desmo95,
