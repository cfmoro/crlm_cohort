...
percent_tum_ann_col_names <- c("%_tum_ann_g", "%_tum_ann_h", "%_tum_ann_i", "%_tum_ann_j", "%_tum_ann_k", "%_tum_ann_l", "%_tum_ann_m", "%_tum_ann_n", "%_tum_ann_o", "%_tum_ann_p")
for(a_col_name in percent_tum_ann_col_names) {
  if(!(a_col_name %in% colnames(tumPercentByTumorDiams))) {
    tumPercentByTumorDiams <-tumPercentByTumorDiams %>% add_column({{a_col_name}} := NA) 
  }
}
