...
# Merge neoadj data
regression_probe <- merge(regression_probe, neoadj_data, by = "ids", all.x = TRUE)
...
# Merge neoadj data
regression_tumor <- merge(regression_tumor, neoadj_data, by = "ids", all.x = TRUE)
...
# Merge neoadj data
regression_slide <- merge(regression_slide, neoadj_data, by = "ids", all.x = TRUE)
