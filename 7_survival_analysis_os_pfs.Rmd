...
clinPatAnnotData$desmo_galjart <- fct_relevel(clinPatAnnotData$desmo_galjart, "[0,33]", "(33,66]","(66,99.9]",  "(99.9,100]" )
```
...
write.csv(pure_desmo_galjart, paste(workDir, "output/pure_desmo_galjart.csv", sep=""), row.names=FALSE)

desmo95 <- filter(clinPatAnnotData, desmo_percent >= 95 & desmo_percent < 100) %>% arrange(neoadjuvant)
write.csv(desmo95, paste(workDir, "output/desmo_95.csv", sep=""), row.names=FALSE)
```
